...
job_info_name = '../../source_job_data/JOB_log.csv'
...
maxPE_file_name = '../../results_job_data/collect_data/all_data/maxPE2.csv'

source_file_name = '../../source_job_data/JOB_log.csv'

IO_mode_file_r = '../../results_job_data/result_data/IOmode_by_volumn/IO_mode_r_count.csv'
IO_mode_file_w = '../../results_job_data/result_data/IOmode_by_volumn/IO_mode_w_count.csv'
...
#        print job, IO_mode[job]
    ...
    (float((len(job_benefit) + 37)/total_job_num)), ch_bene)
